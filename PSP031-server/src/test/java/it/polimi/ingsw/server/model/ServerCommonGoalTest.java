...
class ServerCommonGoalTest {
    ...
    void testEquals() {
        ...
        goal1.achieved()
                .update(l -> List.of(new ServerPlayer("test_player", new PersonalGoal(2), p -> new SerializableProperty<>(0))));
        ...
        goalDiffAchieved.achieved()
                .update(l -> List
                        .of(new ServerPlayer("test_player_1", new PersonalGoal(2), p -> new SerializableProperty<>(0))));

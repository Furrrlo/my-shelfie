...
class ServerPlayerTest {
    ...
    @Test
    void testEquals() {
        final var player1 = new ServerPlayer("test_player_1", new PersonalGoal(1), p -> new SerializableProperty<>(0));
        final var player2 = new ServerPlayer("test_player_1", new PersonalGoal(1), p -> new SerializableProperty<>(0));
        ...
        final var playerDiffNick = new ServerPlayer("test_player_2", new PersonalGoal(1), p -> new SerializableProperty<>(0));
        ...
        final var playerDiffGoal = new ServerPlayer("test_player_1", new PersonalGoal(2), p -> new SerializableProperty<>(0));
        ...
        final var playerDiffScore = new ServerPlayer("test_player_1", new PersonalGoal(1), p -> new SerializableProperty<>(8));
    ...
    @Test
    void testToString() {
        final var player = new ServerPlayer("test_player", new PersonalGoal(2), p -> new SerializableProperty<>(0));

...
public class SpriteConverter {
    ...
    public static void main(String[] args) {
        ...
        sc.SpriteStringConverter(
                "MMMMMMMMMMMMMMMMMMMMMMMM MMMMMMMMMMMMMMMMMMMMMMMM MMMKLKKKKKKKKKKKKKKKKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLKLKMMKMKMKMMKMKKMMRMM MMLKLKMKKMKMKMKKMKKMKRMM MMLKLKMMKMMMKMMKMKKMMRMM MMLKLKKMKMKMKMKKMKKMKRMM MMLKLKMMKMKMKMMKMMKMKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLKLKKKKKKKKKKKKKKKKRMM MMLRLRRRRRRRRRRRRRRRRRMM MMLLLLLLLLLLLLLLLLLLLLMM MMLWWWWWWWWWWWWWWWWWWLMM MMLWMMMMRRRRRMMMMMMMMLMM MMLWMMMMRRRRRMMMMMMMMLMM MMLWMMMMMMMMMMMMMMMMMLMM MMLKKKKKKKKKKKKKKKKKKKMM MMMLLLLLLLLLLLLLLLLLLLMM MMMMMMMMMMMMMMMMMMMMMMMM MMMMMMMMMMMMMMMMMMMMMMMM");
        sc.SpriteStringConverter(
                "NNNNNNNNNNNNNNNNNNNNNNNN NNNNNNNNNNNNNNNNNNNNNNNN NNNNNNNNNNNNNNNNNNNNNNNN NNNNNSSSSSOOOOQQOONNNNNN NNNNNNSSSSSSSSSSSNNNNNNN NNSQQOOSSSOOOOQOOOOQQNNN NNSQNNSSSSOOOOQOONNSQNNN NNSQNNSSSSOOOOQOONNSONNN NNSONNSSSSOOOOQOONNSQNNN NNSONNSSSSOOOOQOONNSQNNN NNSONNSSSSOOOOQOONNSONNN NNSONNSSSSOOOOQOONNSONNN NNSOOOOSSSOOOOQOOOOOONNN NNNNNNSSSSOOOOQOONNNNNNN NNNNNNSSSSOOOOQOONNNNNNN NNNNNNSSSSOOOOOOONNNNNNN NNNNNNNSSSSSSSSSNNNNNNNN NNNNNNNNNNSSSNNNNNNNNNNN NNNNNNNNNNSOQNNNNNNNNNNN NNNNNNNNNNSOQNNNNNNNNNNN NNNNNNNNNSSOOQNNNNNNNNNN NNNNNNNSSSOOOQOONNNNNNNN NNNNNSSSSOOOOOQOOONNNNNN NNNNNNNNNNNNNNNNNNNNNNNN");
        sc.SpriteStringConverter(
                "OOOOOOOOOOOOOOOOOOOOOOOO OOOOOOOOOOOOOOJJJJJJJJOO OOOOOOOOOOOOOJBSSSSSSBHO OOOOOOOOOOOOOJSSJJJJSSHO OOOOOOOOOOOOOJSSJSSJSSHO OOOOOOOOOOOOOJSSSSSJSSHO OOOOOOOOOOOOOJSSSSJSSSHO OOOOOOOOOOOOOJUUUSJSSSHO OOOOOOORRRRROJUUUSSSSSHO OOOOOORRRRRRRRRUUSJSSBHO OOOOOOHHHUUBUOTTTHHHHHOO OOOOOHUHUUUBUUTTTOOOOOOO OOOOOHUHHUUUHUUTTOOOOOOO OOOOOHHUUUUHHHHTOOOOOOOO OOOOOOOUUUUUUUTOOOOOOOOO OOOTTTTTRTTTRTOOOOOOOOOO OOTTTTTTTRTTTROOBOOOOOOO OUUTTTTTTRRRRROOBOOOOOOO OUUUORRTRRORRORBBOOOOOOO OOUOBRRRRRRRRRRBBOOOOOOO OOOBBBRRRRRRRRRBBOOOOOOO OOBBBRRRRRRROOOOOOOOOOOO OOBOORRRROOOOOOOOOOOOOOO OOOOOOOOOOOOOOOOOOOOOOOO");
    }
}
